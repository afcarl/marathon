...
object AppHelpers {
  ...
  private def checkAuthorization[A, B >: A](action: AuthorizedAction[B], resource: A)(implicit identity: Identity, authorizer: Authorizer): A = {
    ...
    else throw RestResource.RejectionException(RestResource.AccessDeniedRejection(authorizer, identity))
  }
  ...
  /**
    ...
    * - [[mesosphere.marathon.api.RestResource.RejectionException]] - AccessDeniedRejection(...)
    *
